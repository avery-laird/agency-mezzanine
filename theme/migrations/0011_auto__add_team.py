...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Team'
        db.create_table(u'theme_team', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('_order', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('homepage', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team', to=orm['theme.HomePage'])),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team', to=orm['theme.Section'])),
            ('profile_picture', self.gf('mezzanine.core.fields.FileField')(max_length=255)),
        ...
        db.send_create_signal(u'theme', ['Team'])


    def backwards(self, orm):
        # Deleting model 'Team'
        db.delete_table(u'theme_team')
