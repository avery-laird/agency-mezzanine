...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Slide.homepage'
        db.delete_column(u'theme_slide', 'homepage_id')


    def backwards(self, orm):
        # Adding field 'Slide.homepage'
        db.add_column(u'theme_slide', 'homepage',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2014, 12, 22, 0, 0), related_name='slides', to=orm['theme.HomePage']),
                      keep_default=False)
    ...
    models = {
        ...
        u'theme.iconblurb': {
            ...
            'homepage': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'blurbs'", 'to': u"orm['theme.Section']"}),
