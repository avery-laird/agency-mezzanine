...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'theme_timeline', (
            (u'iconblurb_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['theme.IconBlurb'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'theme', ['TimeLine'])


    def backwards(self, orm):
        # Deleting model 'TimeLine'
        db.delete_table(u'theme_timeline')
    ...
    models = {
        ...
        u'theme.timeline': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'TimeLine', '_ormbases': [u'theme.IconBlurb']},
            u'iconblurb_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['theme.IconBlurb']", 'unique': 'True', 'primary_key': 'True'}),
