...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TimeLine.iconblurb_ptr'
        db.delete_column(u'theme_timeline', u'iconblurb_ptr_id')

        # Adding field 'TimeLine.id'
        db.add_column(u'theme_timeline', u'id',
                      self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True),
                      keep_default=False)

        # Adding field 'TimeLine._order'
        db.add_column(u'theme_timeline', '_order',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'TimeLine.homepage'
        db.add_column(u'theme_timeline', 'homepage',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='timeline', to=orm['theme.HomePage']),
                      keep_default=False)

        # Adding field 'TimeLine.section'
        db.add_column(u'theme_timeline', 'section',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='timeline', to=orm['theme.Section']),
                      keep_default=False)

        # Adding field 'TimeLine.header'
        db.add_column(u'theme_timeline', 'header',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=140),
                      keep_default=False)

        # Adding field 'TimeLine.content'
        db.add_column(u'theme_timeline', 'content',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TimeLine.iconblurb_ptr'
        raise RuntimeError("Cannot reverse this migration. 'TimeLine.iconblurb_ptr' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TimeLine.iconblurb_ptr'
        db.add_column(u'theme_timeline', u'iconblurb_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['theme.IconBlurb'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'TimeLine.id'
        db.delete_column(u'theme_timeline', u'id')

        # Deleting field 'TimeLine._order'
        db.delete_column(u'theme_timeline', '_order')

        # Deleting field 'TimeLine.homepage'
        db.delete_column(u'theme_timeline', 'homepage_id')

        # Deleting field 'TimeLine.section'
        db.delete_column(u'theme_timeline', 'section_id')

        # Deleting field 'TimeLine.header'
        db.delete_column(u'theme_timeline', 'header')

        # Deleting field 'TimeLine.content'
        db.delete_column(u'theme_timeline', 'content')
